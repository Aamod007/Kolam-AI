    ...
    <header className="sticky top-0 z-40 w-full border-b bg-black/40 backdrop-blur supports-[backdrop-filter]:bg-black/30">
      <div className="container flex h-14 items-center justify-between">
        ...
        <nav className="flex items-center gap-6 text-sm text-muted-foreground">
          ...
          <span
            className="relative flex items-center justify-center w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-gradient-to-br from-yellow-300/80 to-yellow-500/80 shadow-lg border-2 border-yellow-400/60 opacity-80 cursor-not-allowed select-none"
