        ...
        <main className="container py-8 flex flex-col items-center justify-center min-h-screen">
          ...
          <section className="mt-12 grid gap-6 md:grid-cols-2 lg:grid-cols-3 w-full justify-center text-center" style={{ marginRight: '2.5rem' }}>
            ...
            <KolamCard
              ...
              description="Animated tutorials that teach you how to draw Kolams dot-by-dot. Learn Sikku loops and Pulli lines!"
              buttonText={<><BookOpen className="h-5 w-5 text-green-400 mr-2" />Open</>}
              buttonHref="/learning-mode"
              list={["Animated tutorials", "Traceable paths", "Pulli & Sikku styles"]}
            />
            <KolamCard
            ...
            <div className="space-y-7 bg-gradient-to-br from-[#2a0a1a] via-[#280c1a] to-[#bfa335]/10 rounded-2xl p-6 border-2 border-yellow-300/60 shadow-lg">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-yellow-100 font-serif">Interactive SVG animations showing how to draw Kolams dot-by-dot. <span className='font-bold text-green-400'>Live now!</span> <span className='italic text-yellow-200'>Start learning today!</span></p>
                </div>
              </div>
              {/* Roadmap Item 6 */}
              <div className="flex items-start gap-4 opacity-90">
